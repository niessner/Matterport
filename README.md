...
To download the dataset, you must indicate that you agree to the terms of use by signing the [Terms of Use](http://kaldir.vc.cit.tum.de/matterport/MP_TOS.pdf) agreement form, using your institutional email addresses, and sending it to: [matterport3d@googlegroups.com](mailto:matterport3d@googlegroups.com).  We will then provide download access to the dataset.
